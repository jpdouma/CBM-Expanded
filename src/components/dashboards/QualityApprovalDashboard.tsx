// ==> src/components/dashboards/QualityApprovalDashboard.tsx <==
...
import { CheckCircle2, AlertCircle, Clock, Hammer, UserCheck } from 'lucide-react';
        ...
        <div className="p-6 space-y-8 max-w-7xl mx-auto">
            <header className="flex justify-between items-end">
                <div>
                    ...
                    <p className="text-gray-400 font-medium">Review and approve processing transitions.</p>
                </div>
